...
L["Change the brightness of the power bar background color, relative to the foreground color."] = "Cambiar el brillo de los fondos de las barras de salud, en relación con el color de primer plano."

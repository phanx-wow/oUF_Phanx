--[[--------------------------------------------------------------------
	...
	This file adds support for maintank and mainassist units.
...
--	Merge maintanks and mainassists?
oUF_Phanx.settings.tankAssists = true

oUF_Phanx.settings.tankTargets = 2

oUF_Phanx.settings.units.maintank = {
	width = 100,
	height = 25,
	power = true,
	reverse = true,
...
oUF_Phanx.settings.units.mainassist = {
	width = 100,
	height = 20,
	reverse = true,

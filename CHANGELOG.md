...
* Add fontScale option -- no UI yet, use "/run oUFPhanxConfig.fontScale = N" and "/reload", where N is a number from 0.5 to 1.5
...
### Version 3.2.0.22-beta

* Fix druid mana text
* Fix aura placement on player unit

### Version 3.1.3.18-beta

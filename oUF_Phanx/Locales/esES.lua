...
L["oUF_Phanx is a layout for Haste's oUF framework. Use this panel to configure some basic options for this layout."] = "oUF_Phanx es un diseño para oUF, por Haste. Estas opciones te permiten modificar la configuración de oUF_Phanx."

L["Texture"] = "Textura"
L["Select a texture for health, power, and other bars."] = "Establecer la textura para las barras de salud, poder, etc."

L["Font"] = "Fuente"
L["Select a typeface for text on the frames."] = "Establecer la fuente para el texto en los marcos."
...
L["Show a mana bar while you are in Cat Form or Bear Form."] = "Mostrar una barra de maná cuando estás en forma felina o de oso."
...
L["Show rune bars"] = "Barras de runas"
L["Show timer bars for your runes above the player frame."] = "Mostrar barras de tiempo para tus runas sobre el maro de tu personaje."
L["Show totem bars"] = "Barras de totems"
L["Show timer bars for your totems above the player frame."] = "Mostrar barras de tiempo para tus totems sobre el maro de tu personaje."

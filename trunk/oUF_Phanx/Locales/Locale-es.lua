...
L.AddAura_Info = "Introduce el ID de un hechizo y pulse Intro."
...
L.Auras = "Auras"
L.Auras_Info = "Añadir nuevos beneficios y perjuicios para mostrar, o cambiar cómo se filtran las auras predefinidos."
...
L.DeleteAura = "Eliminar el filtro personalizado para este aura."
...
L.None = "Ninguno"
L.OptionRequiresReload = "Esta opción no tendrá efecto hasta la próxima vez que se conecte o vuelva a cargar la interfaz de usuario."
